...
namespace EntityJustworksGUI
{
    public partial class MainForm : Form
    {
		...
		private void btnScript_InsertIntoParameterized_Click(object sender, EventArgs e)
		{
			...
			//SqlCeConnection connection = new SqlCeConnection(/*@"Data Source=C:\Users\CodeNinja\Documents\Visual Studio 2015\Projects\EntityJustWorks\EntityJustworksGUI\Database001.mdf;"*/connstrBuilder.ConnectionString);
			//connection.Open();
